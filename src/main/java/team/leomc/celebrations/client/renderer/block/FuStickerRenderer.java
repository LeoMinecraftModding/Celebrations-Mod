...
import team.leomc.celebrations.block.FuStickerBlock;
...
public class FuStickerRenderer implements BlockEntityRenderer<FuStickerBlockEntity> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Celebrations.id("fu_sticker"), "main");
