...
public class CDataComponents {
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<BalloonData>> BALLOON_DATA = DATA_COMPONENTS.register("balloon_data", () -> DataComponentType.<BalloonData>builder().persistent(BalloonData.CODEC).networkSynchronized(BalloonData.STREAM_CODEC).build());
}
