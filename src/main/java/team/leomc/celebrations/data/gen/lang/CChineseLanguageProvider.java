...
public class CChineseLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		add(CItems.FU_STICKER.get(), "福字");
		add(CItems.INVERTED_FU_STICKER.get(), "倒福字");
		add(CItems.GOLDEN_FU_STICKER.get(), "金色福字");
		add(CItems.INVERTED_GOLDEN_FU_STICKER.get(), "金色倒福字");
		...
		add(CEntities.FU_STICKER.get(), "福字");
