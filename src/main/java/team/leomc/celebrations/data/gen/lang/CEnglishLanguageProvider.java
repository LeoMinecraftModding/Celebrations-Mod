...
public class CEnglishLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		add(CItems.FU_STICKER.get(), "Fu Sticker");
		add(CItems.INVERTED_FU_STICKER.get(), "Inverted Fu Sticker");
		add(CItems.GOLDEN_FU_STICKER.get(), "Golden Fu Sticker");
		add(CItems.INVERTED_GOLDEN_FU_STICKER.get(), "Inverted Golden Fu Sticker");
		...
		add(CEntities.FU_STICKER.get(), "Fu Sticker");
